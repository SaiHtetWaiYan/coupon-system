        ...
        <div class="overflow-hidden rounded-lg bg-white shadow dark:bg-gray-800">
            <form action="{{ route('admin.users.update', $user) }}" method="POST" class="space-y-6 p-6">
                ...
                <div class="flex items-center">
                    ...
                    <input type="checkbox" id="is_admin" name="is_admin" value="1" class="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-600 dark:border-gray-600 dark:bg-gray-700" {{ old('is_admin', $user->is_admin) ? 'checked' : '' }}>
