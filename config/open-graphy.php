...
return [
    'chrome_binary' => '/Applications/Google Chrome.app/Contents/MacOS/Google Chrome', // leave empty for autodiscovery, or set it to 'chrome' or 'chromium' depending on the binary you want to use. You can also provide full path to the binary
